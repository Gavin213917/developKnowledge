 ...
 *
 * <p>
 * <code>KeKeFileWriter</code> is meant for writing streams of characters. For
 * writing streams of raw bytes, consider using a <code>FileOutputStream</code>.
 *
...
public class KeKeFileWriter extends OutputStreamWriter {

	/**
	 * Constructs a KeKeFileWriter object given a file name.
	 *
	 * @param fileName
	...
	public KeKeFileWriter(String fileName, String charset) throws IOException {
		super(new FileOutputStream(fileName), charset);
	}

	public KeKeFileWriter(File fileName, String charset) throws IOException {
		super(new FileOutputStream(fileName), charset);
	}

	public KeKeFileWriter(File fileName, String charset, boolean append) throws IOException {
		super(new FileOutputStream(fileName, append), charset);
	}

	public KeKeFileWriter(String fileName, String charset, boolean append) throws IOException {
		super(new FileOutputStream(fileName, append), charset);
	}

	/**
	 * Constructs a KeKeFileWriter object given a file name with a boolean
	...
	/**
	 * Constructs a KeKeFileWriter object given a File object.
	 *
	 * @param file
	...
	/**
	 * Constructs a KeKeFileWriter object given a File object. If the second
	...
	/**
	 * Constructs a KeKeFileWriter object associated with a file descriptor.
	 *
	 * @param fd
	 *            FileDescriptor object to write to.
	 */
	public KeKeFileWriter(FileDescriptor fd) {
