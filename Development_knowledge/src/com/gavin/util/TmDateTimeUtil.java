...
import static com.gavin.other.date.TmDateUtil.Format_Date;
import static com.gavin.other.date.TmDateUtil.Format_DateTime;
import static com.gavin.other.date.TmDateUtil.parse;
...
import com.gavin.other.date.TmTimeInterval;
...
public class TmDateTimeUtil {
	...
	public static String getPrevOrNextDay(String type, String dateTime) {
		if (StringUtils.isNotEmpty(type) && type.equals(YESTERDAY)) {
			return getMinusDays(dateTime);
		}
		if (StringUtils.isNotEmpty(type) && type.equals(TOMORROW)) {
